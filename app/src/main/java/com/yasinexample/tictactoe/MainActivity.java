package com.yasinexample.tictactoe;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this procedure's optimized form is up for cycle*/
    ...
    public int gameEnded(int row, int col){
        ...
        for (int i=0; i<3; i++) {
            if (board[0][col] == symbol && board[1][col] == symbol && board[2][col] == symbol) {
                win = true;
                break;
            }else if (board[row][0] == symbol && board[row][1] == symbol && board[row][2] == symbol) {
                win = true;
                break;
            }else if ((board[0][0] == symbol && board[1][1] == symbol && board[2][2] == symbol) || (board[2][0] == symbol && board[1][1] == symbol &&  board[0][2] == symbol)) {
                win = true;
                break;
            }
        }
